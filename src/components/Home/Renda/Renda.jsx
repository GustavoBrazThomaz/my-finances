...
import { Box, Button, Card, CardActions, CardContent, Dialog, DialogActions, DialogContent, DialogTitle, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography } from '@mui/material'
import NumberFormat from 'react-number-format'
import moment from 'moment';

function Renda({ renda, cardStyle, date, setDate }) {
    ...
    return (
        <div>
            <Card sx={cardStyle}>
                ...
                <Box sx={{ display: 'flex' }}>
                    ...
                    <CardActions sx={{ marginRight: 1 }}>
                        <Button variant="outlined" color="success" onClick={handleClickOpen}>Adcionar Renda</Button>
                    </CardActions>
                </Box>
                            ...
                            <TableBody>
                                {renda.map((row) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align="left"> <Typography variant='span' sx={{ color: '#48b302', fontWeight: 'bold' }}>+</Typography> R$: {row.price}</TableCell>
                                    </TableRow>
                                ))}
                            </TableBody>
                        </Table>
            ...
            <Dialog open={open} onClose={handleClose}>
                <DialogTitle sx={{ marginTop: 1 }}>Adicionar Renda</DialogTitle>
